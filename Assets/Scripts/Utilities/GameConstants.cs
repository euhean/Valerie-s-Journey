...
/// <summary>
/// Entity states and helper methods to reduce state checking code.
/// </summary>
public static class EntityStates {
    ...
    /// <summary>
    /// Quick check if entity is active and ready for combat
    /// </summary>
    public static bool IsActiveAndOnDuty(Entity entity) {
        return entity != null && entity.currentState == Entity.EntityState.ALIVE && entity.onDuty;
    }
    
    /// <summary>
    /// Quick check if entity can take damage
    /// </summary>
    public static bool CanTakeDamage(Entity entity) {
        return entity != null && entity.currentState == Entity.EntityState.ALIVE;
    }
}